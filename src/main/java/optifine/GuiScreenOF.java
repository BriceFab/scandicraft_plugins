...
public class GuiScreenOF extends GuiScreen {
    ...
    public static GuiButton getSelectedButton(List<BaseButton> p_getSelectedButton_0_, int p_getSelectedButton_1_, int p_getSelectedButton_2_) {
        for (BaseButton baseButton : p_getSelectedButton_0_) {
            GuiButton guibutton = (GuiButton) baseButton;
