...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    {
        return blockIn != Blocks.bedrock && blockIn != Blocks.end_portal && blockIn != Blocks.end_portal_frame && blockIn != Blocks.command_block && blockIn != Blocks.barrier;
    }
    ...
    {
        this.dataWatcher.updateObject(20, Integer.valueOf(time));
    }
    ...
    {
        return this.dataWatcher.getWatchableObjectInt(17 + head);
    }
