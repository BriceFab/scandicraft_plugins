...
{
    private static final Predicate<IBlockState> IS_GRASS = BlockStateHelper.forBlock(Blocks.tallgrass).where(BlockTallGrass.TYPE, Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            return IS_GRASS.apply(this.entityWorld.getBlockState(blockpos)) ? true : this.entityWorld.getBlockState(blockpos.down()).getBlock() == Blocks.grass;
        }
    }
