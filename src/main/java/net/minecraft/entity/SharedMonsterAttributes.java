...
public class SharedMonsterAttributes
{
    ...
    public static final IAttribute maxHealth = (new RangedAttribute((IAttribute)null, "generic.maxHealth", 24.0D, 0.0D, 1024.0D)).setDescription("Max Health").setShouldWatch(true);
