...
import net.scandicraft.recipes.Ingots;
...
public class RecipesIngots {
    ...
    //ScandiCraft call ingots
    private final Object[][] allRecipes = ArrayUtils.addAll(recipeItems, Ingots.recipeItems);

    /**
     * Adds the ingot recipes to the CraftingManager.
     */
    public void addRecipes(CraftingManager p_77590_1_) {
        for (Object[] recipeItem : this.allRecipes) {
