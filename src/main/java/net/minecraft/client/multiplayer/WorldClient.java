...
public class WorldClient extends World {
    ...
    public void doVoidFogParticles(int posX, int posY, int posZ) {
        ...
        boolean flag = this.mc.playerController.getCurrentGameType() == WorldSettings.GameType.CREATIVE && itemstack != null && (Block.getBlockFromItem(itemstack.getItem()) == Blocks.barrier || Block.getBlockFromItem(itemstack.getItem()) == ScandiCraftBlocks.light || Block.getBlockFromItem(itemstack.getItem()) == ScandiCraftBlocks.dungeon_spawner);
        ...
        for (int i = 0; i < 1000; ++i) {
            ...
            if (flag && (iblockstate.getBlock() == Blocks.barrier || iblockstate.getBlock() == ScandiCraftBlocks.light || iblockstate.getBlock() == ScandiCraftBlocks.dungeon_spawner)) {
