...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    //ScandiCraft change private to public
    ...
    public void renderItemModelForEntity(ItemStack stack, EntityLivingBase entityToRenderFor, ItemCameraTransforms.TransformType cameraTransformType) {
        if (stack != null && entityToRenderFor != null) {
            ...
            if (entityToRenderFor instanceof EntityPlayer) {
                ...
                } else if (item == ScandiCraftItems.scandium_bow && entityplayer.getItemInUse() != null) {
                    int i = stack.getMaxItemUseDuration() - entityplayer.getItemInUseCount();

                    if (i >= 18) {
                        modelresourcelocation = new ModelResourceLocation("scandium_bow_pulling_2", "inventory");
                    } else if (i > 13) {
                        modelresourcelocation = new ModelResourceLocation("scandium_bow_pulling_1", "inventory");
                    } else if (i > 0) {
                        modelresourcelocation = new ModelResourceLocation("scandium_bow_pulling_0", "inventory");
                    }
    ...
    private void registerItems() {
        ...
        //ScandiCraft call register new render
        net.scandicraft.render.Item.registerItems(this);
