...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            GuiFlatPresets.this.export.setText(((GuiFlatPresets.LayerItem)GuiFlatPresets.FLAT_WORLD_PRESETS.get(GuiFlatPresets.this.list.field_148175_k)).generatorInfo);
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            this.func_178054_a(p_180791_2_, p_180791_3_, guiflatpresets$layeritem.icon, guiflatpresets$layeritem.field_179037_b);
