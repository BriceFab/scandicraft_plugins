        ...
        public void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                if (this.field_146155_p) {
                    this.field_146156_o = (float) (mouseX - (this.xPosition + 4)) / (float) (this.getWidth() - 8);
                ...
                this.drawTexturedModalRect(this.xPosition + (int) (this.field_146156_o * (float) (this.getWidth() - 8)), this.yPosition, 0, 66, 4, 20);
                this.drawTexturedModalRect(this.xPosition + (int) (this.field_146156_o * (float) (this.getWidth() - 8)) + 4, this.yPosition, 196, 66, 4, 20);
            }
        }
