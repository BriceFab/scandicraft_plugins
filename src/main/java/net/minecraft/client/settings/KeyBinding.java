...
public class KeyBinding implements Comparable<KeyBinding> {
    ...
    private static final Set<String> keybindSetMinecraft = Sets.newHashSet();
    private static final Set<String> keybindSetScandiCraft = Sets.newHashSet();
    ...
    public static Set<String> getKeybindsMinecraft() {
        return keybindSetMinecraft;
    }

    public static Set<String> getKeybindsScandiCraft() {
        return keybindSetScandiCraft;
    }

    public KeyBinding(String description, int keyCode, String category, KeyBindingType type) {
        ...
        switch (type) {
            default:
                return;
            case MINECRAFT:
                keybindSetMinecraft.add(category);
                return;
            case SCANDICRAFT:
                keybindSetScandiCraft.add(category);
                return;
        }
    }
