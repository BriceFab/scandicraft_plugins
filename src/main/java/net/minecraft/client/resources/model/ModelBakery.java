...
public class ModelBakery {
    ...
    private void registerVariantNames() {
        ...
        this.variantNames.put(ScandiCraftItems.scandium_bow, Lists.newArrayList("scandium_bow", "scandium_bow_pulling_0", "scandium_bow_pulling_1", "scandium_bow_pulling_2"));
