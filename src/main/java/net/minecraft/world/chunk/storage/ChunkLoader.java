...
public class ChunkLoader
{
    ...
    public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData converterData, NBTTagCompound compound, WorldChunkManager provider)
    {
        ...
        for (int l2 = 0; l2 < 16; ++l2)
        {
            for (int i3 = 0; i3 < 16; ++i3)
            {
                ...
                abyte[i3 << 4 | l2] = (byte)(provider.getBiomeGenerator(blockpos$mutableblockpos, BiomeGenBase.DEFAULT).biomeID & 255);
            }
        }
