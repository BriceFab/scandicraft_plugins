...
public class ChunkProviderSettings {
    ...
    public static class Factory {
                                                        ...
                                                        (Float.compare(chunkprovidersettings$factory.biomeDepthOffset, this.biomeDepthOffset) != 0 ? false :
                                                                (Float.compare(chunkprovidersettings$factory.biomeDepthWeight, this.biomeDepthWeight) != 0 ? false :
                                                                        (Float.compare(chunkprovidersettings$factory.biomeScaleOffset, this.biomeScaleOffset) != 0 ? false :
                                                                                (Float.compare(chunkprovidersettings$factory.biomeScaleWeight, this.biomeScaleWeight) != 0 ? false : (this.biomeSize != chunkprovidersettings$factory.biomeSize ? false :
                                                                                        (this.coalCount != chunkprovidersettings$factory.coalCount ? false : (this.coalMaxHeight != chunkprovidersettings$factory.coalMaxHeight ? false :
                                                                                                (this.coalMinHeight != chunkprovidersettings$factory.coalMinHeight ? false :
                                                                                                        (this.coalSize != chunkprovidersettings$factory.coalSize ? false :
                                                                                                                (Float.compare(chunkprovidersettings$factory.coordinateScale, this.coordinateScale) != 0 ? false :
                                                                                                                        (Float.compare(chunkprovidersettings$factory.depthNoiseScaleExponent, this.depthNoiseScaleExponent) != 0 ? false :
                                                                                                                                (Float.compare(chunkprovidersettings$factory.depthNoiseScaleX, this.depthNoiseScaleX) != 0 ? false :
                                                                                                                                        (Float.compare(chunkprovidersettings$factory.depthNoiseScaleZ, this.depthNoiseScaleZ) != 0 ? false :
                                                                                                                                                (this.diamondCount != chunkprovidersettings$factory.diamondCount ? false :
                                                                                                                                                        (this.diamondMaxHeight != chunkprovidersettings$factory.diamondMaxHeight ? false :
                                                                                                                                                                (this.diamondMinHeight != chunkprovidersettings$factory.diamondMinHeight ? false :
                                                                                                                                                                        (this.diamondSize != chunkprovidersettings$factory.diamondSize ? false :
                                                                                                                                                                                (this.lazuriteCount != chunkprovidersettings$factory.lazuriteCount ? false :
                                                                                                                                                                                        (this.lazuriteMaxHeight != chunkprovidersettings$factory.lazuriteMaxHeight ? false :
                                                                                                                                                                                                (this.lazuriteMinHeight != chunkprovidersettings$factory.lazuriteMinHeight ? false :
                                                                                                                                                                                                        (this.lazuriteSize != chunkprovidersettings$factory.lazuriteSize ? false :
                                                                                                                                                                                                                (this.pyriteCount != chunkprovidersettings$factory.pyriteCount ? false :
                                                                                                                                                                                                                        (this.pyriteMaxHeight != chunkprovidersettings$factory.pyriteMaxHeight ? false :
                                                                                                                                                                                                                                (this.pyriteMinHeight != chunkprovidersettings$factory.pyriteMinHeight ? false :
                                                                                                                                                                                                                                        (this.pyriteSize != chunkprovidersettings$factory.pyriteSize ? false :
                                                                                                                                                                                                                                                (this.scandiumCount != chunkprovidersettings$factory.scandiumCount ? false :
                                                                                                                                                                                                                                                        (this.scandiumMaxHeight != chunkprovidersettings$factory.scandiumMaxHeight ? false :
                                                                                                                                                                                                                                                                (this.scandiumMinHeight != chunkprovidersettings$factory.scandiumMinHeight ? false :
                                                                                                                                                                                                                                                                        (this.scandiumSize != chunkprovidersettings$factory.scandiumSize ? false :
                                                                                                                                                                                                                                                                                (this.randomOreCount != chunkprovidersettings$factory.randomOreCount ? false :
                                                                                                                                                                                                                                                                                        (this.randomOreMaxHeight != chunkprovidersettings$factory.randomOreMaxHeight ? false :
                                                                                                                                                                                                                                                                                                (this.randomOreMinHeight != chunkprovidersettings$factory.randomOreMinHeight ? false :
                                                                                                                                                                                                                                                                                                        (this.randomOreSize != chunkprovidersettings$factory.randomOreSize ? false :
                                                                                                                                                                                                                                                                                                                (this.dioriteCount != chunkprovidersettings$factory.dioriteCount ? false :
                                                                                                                                                                                                                                                                                                                        (this.dioriteMaxHeight != chunkprovidersettings$factory.dioriteMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                (this.dioriteMinHeight != chunkprovidersettings$factory.dioriteMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                        (this.dioriteSize != chunkprovidersettings$factory.dioriteSize ? false :
                                                                                                                                                                                                                                                                                                                                                (this.dirtCount != chunkprovidersettings$factory.dirtCount ? false :
                                                                                                                                                                                                                                                                                                                                                        (this.dirtMaxHeight != chunkprovidersettings$factory.dirtMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                (this.dirtMinHeight != chunkprovidersettings$factory.dirtMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                        (this.dirtSize != chunkprovidersettings$factory.dirtSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                (this.dungeonChance != chunkprovidersettings$factory.dungeonChance ? false :
                                                                                                                                                                                                                                                                                                                                                                                        (this.fixedBiome != chunkprovidersettings$factory.fixedBiome ? false :
                                                                                                                                                                                                                                                                                                                                                                                                (this.goldCount != chunkprovidersettings$factory.goldCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                        (this.goldMaxHeight != chunkprovidersettings$factory.goldMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                (this.goldMinHeight != chunkprovidersettings$factory.goldMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                        (this.goldSize != chunkprovidersettings$factory.goldSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                (this.graniteCount != chunkprovidersettings$factory.graniteCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.graniteMaxHeight != chunkprovidersettings$factory.graniteMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.graniteMinHeight != chunkprovidersettings$factory.graniteMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.graniteSize != chunkprovidersettings$factory.graniteSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.gravelCount != chunkprovidersettings$factory.gravelCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.gravelMaxHeight != chunkprovidersettings$factory.gravelMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.gravelMinHeight != chunkprovidersettings$factory.gravelMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.gravelSize != chunkprovidersettings$factory.gravelSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Float.compare(chunkprovidersettings$factory.heightScale, this.heightScale) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.ironCount != chunkprovidersettings$factory.ironCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.ironMaxHeight != chunkprovidersettings$factory.ironMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.ironMinHeight != chunkprovidersettings$factory.ironMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.ironSize != chunkprovidersettings$factory.ironSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.lapisCenterHeight != chunkprovidersettings$factory.lapisCenterHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.lapisCount != chunkprovidersettings$factory.lapisCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.lapisSize != chunkprovidersettings$factory.lapisSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.lapisSpread != chunkprovidersettings$factory.lapisSpread ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.lavaLakeChance != chunkprovidersettings$factory.lavaLakeChance ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Float.compare(chunkprovidersettings$factory.lowerLimitScale, this.lowerLimitScale) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (Float.compare(chunkprovidersettings$factory.mainNoiseScaleX, this.mainNoiseScaleX) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Float.compare(chunkprovidersettings$factory.mainNoiseScaleY, this.mainNoiseScaleY) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (Float.compare(chunkprovidersettings$factory.mainNoiseScaleZ, this.mainNoiseScaleZ) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.redstoneCount != chunkprovidersettings$factory.redstoneCount ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.redstoneMaxHeight != chunkprovidersettings$factory.redstoneMaxHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.redstoneMinHeight != chunkprovidersettings$factory.redstoneMinHeight ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.redstoneSize != chunkprovidersettings$factory.redstoneSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.riverSize != chunkprovidersettings$factory.riverSize ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.seaLevel != chunkprovidersettings$factory.seaLevel ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Float.compare(chunkprovidersettings$factory.stretchY, this.stretchY) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (Float.compare(chunkprovidersettings$factory.upperLimitScale, this.upperLimitScale) != 0 ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useCaves != chunkprovidersettings$factory.useCaves ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.useDungeons != chunkprovidersettings$factory.useDungeons ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useLavaLakes != chunkprovidersettings$factory.useLavaLakes ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.useLavaOceans != chunkprovidersettings$factory.useLavaOceans ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useMineShafts != chunkprovidersettings$factory.useMineShafts ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.useRavines != chunkprovidersettings$factory.useRavines ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useStrongholds != chunkprovidersettings$factory.useStrongholds ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.useTemples != chunkprovidersettings$factory.useTemples ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useMonuments != chunkprovidersettings$factory.useMonuments ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (this.useVillages != chunkprovidersettings$factory.useVillages ? false :
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (this.useWaterLakes != chunkprovidersettings$factory.useWaterLakes ? false :
        ...
        public int hashCode() {
            ...
            i = 31 * i + this.lazuriteSize;
            i = 31 * i + this.lazuriteCount;
            i = 31 * i + this.lazuriteMinHeight;
            i = 31 * i + this.lazuriteMaxHeight;
            i = 31 * i + this.pyriteSize;
            i = 31 * i + this.pyriteCount;
            i = 31 * i + this.pyriteMinHeight;
            i = 31 * i + this.pyriteMaxHeight;
            i = 31 * i + this.scandiumSize;
            i = 31 * i + this.scandiumCount;
            i = 31 * i + this.scandiumMinHeight;
            i = 31 * i + this.scandiumMaxHeight;
            i = 31 * i + this.randomOreSize;
            i = 31 * i + this.randomOreCount;
            i = 31 * i + this.randomOreMinHeight;
            i = 31 * i + this.randomOreMaxHeight;
    ...
    public static class Serializer implements JsonDeserializer<ChunkProviderSettings.Factory>, JsonSerializer<ChunkProviderSettings.Factory> {
        public ChunkProviderSettings.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            try {
                ...
                chunkprovidersettings$factory.lazuriteSize = JsonUtils.getInt(jsonobject, "lazuriteSize", chunkprovidersettings$factory.lazuriteSize);
                chunkprovidersettings$factory.lazuriteCount = JsonUtils.getInt(jsonobject, "lazuriteCount", chunkprovidersettings$factory.lazuriteCount);
                chunkprovidersettings$factory.lazuriteMinHeight = JsonUtils.getInt(jsonobject, "lazuriteMinHeight", chunkprovidersettings$factory.lazuriteMinHeight);
                chunkprovidersettings$factory.lazuriteMaxHeight = JsonUtils.getInt(jsonobject, "lazuriteMaxHeight", chunkprovidersettings$factory.lazuriteMaxHeight);
                chunkprovidersettings$factory.pyriteSize = JsonUtils.getInt(jsonobject, "pyriteSize", chunkprovidersettings$factory.pyriteSize);
                chunkprovidersettings$factory.pyriteCount = JsonUtils.getInt(jsonobject, "pyriteCount", chunkprovidersettings$factory.pyriteCount);
                chunkprovidersettings$factory.pyriteMinHeight = JsonUtils.getInt(jsonobject, "pyriteMinHeight", chunkprovidersettings$factory.pyriteMinHeight);
                chunkprovidersettings$factory.pyriteMaxHeight = JsonUtils.getInt(jsonobject, "pyriteMaxHeight", chunkprovidersettings$factory.pyriteMaxHeight);
                chunkprovidersettings$factory.scandiumSize = JsonUtils.getInt(jsonobject, "scandiumSize", chunkprovidersettings$factory.scandiumSize);
                chunkprovidersettings$factory.scandiumCount = JsonUtils.getInt(jsonobject, "scandiumCount", chunkprovidersettings$factory.scandiumCount);
                chunkprovidersettings$factory.scandiumMinHeight = JsonUtils.getInt(jsonobject, "scandiumMinHeight", chunkprovidersettings$factory.scandiumMinHeight);
                chunkprovidersettings$factory.scandiumMaxHeight = JsonUtils.getInt(jsonobject, "scandiumMaxHeight", chunkprovidersettings$factory.scandiumMaxHeight);
                chunkprovidersettings$factory.randomOreSize = JsonUtils.getInt(jsonobject, "randomOreSize", chunkprovidersettings$factory.randomOreSize);
                chunkprovidersettings$factory.randomOreCount = JsonUtils.getInt(jsonobject, "randomOreCount", chunkprovidersettings$factory.randomOreCount);
                chunkprovidersettings$factory.randomOreMinHeight = JsonUtils.getInt(jsonobject, "randomOreMinHeight", chunkprovidersettings$factory.randomOreMinHeight);
                chunkprovidersettings$factory.randomOreMaxHeight = JsonUtils.getInt(jsonobject, "randomOreMaxHeight", chunkprovidersettings$factory.randomOreMaxHeight);
        ...
        public JsonElement serialize(ChunkProviderSettings.Factory p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
            ...
            jsonobject.addProperty("lazuriteSize", (Number) Integer.valueOf(p_serialize_1_.lazuriteSize));
            jsonobject.addProperty("lazuriteCount", (Number) Integer.valueOf(p_serialize_1_.lazuriteCount));
            jsonobject.addProperty("lazuriteMinHeight", (Number) Integer.valueOf(p_serialize_1_.lazuriteMinHeight));
            jsonobject.addProperty("lazuriteMaxHeight", (Number) Integer.valueOf(p_serialize_1_.lazuriteMaxHeight));
            jsonobject.addProperty("pyriteSize", (Number) Integer.valueOf(p_serialize_1_.pyriteSize));
            jsonobject.addProperty("pyriteCount", (Number) Integer.valueOf(p_serialize_1_.pyriteCount));
            jsonobject.addProperty("pyriteMinHeight", (Number) Integer.valueOf(p_serialize_1_.pyriteMinHeight));
            jsonobject.addProperty("pyriteMaxHeight", (Number) Integer.valueOf(p_serialize_1_.pyriteMaxHeight));
            jsonobject.addProperty("scandiumSize", (Number) Integer.valueOf(p_serialize_1_.scandiumSize));
            jsonobject.addProperty("scandiumCount", (Number) Integer.valueOf(p_serialize_1_.scandiumCount));
            jsonobject.addProperty("scandiumMinHeight", (Number) Integer.valueOf(p_serialize_1_.scandiumMinHeight));
            jsonobject.addProperty("scandiumMaxHeight", (Number) Integer.valueOf(p_serialize_1_.scandiumMaxHeight));
            jsonobject.addProperty("randomOreSize", (Number) Integer.valueOf(p_serialize_1_.randomOreSize));
            jsonobject.addProperty("randomOreCount", (Number) Integer.valueOf(p_serialize_1_.randomOreCount));
            jsonobject.addProperty("randomOreMinHeight", (Number) Integer.valueOf(p_serialize_1_.randomOreMinHeight));
            jsonobject.addProperty("randomOreMaxHeight", (Number) Integer.valueOf(p_serialize_1_.randomOreMaxHeight));
