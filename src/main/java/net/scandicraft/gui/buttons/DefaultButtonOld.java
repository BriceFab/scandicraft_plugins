...
public class DefaultButtonOld extends Gui {
    ...
    public DefaultButtonOld(int buttonId, int x, int y, String buttonText) {
    ...
    public DefaultButtonOld(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
        this.width = 200;
        this.height = 20;
        this.enabled = true;
        this.visible = true;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (visible) {
            ...
            if (this.texture != null) {
                ...
                int overState = 1;// this.getHoverState(this.hovered);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                GlStateManager.blendFunc(770, 771);
                this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 46 + overState * 20, this.width / 2, this.height);
                this.drawTexturedModalRect(this.xPosition + this.width / 2, this.yPosition, 200 - this.width / 2, 46 + overState * 20, this.width / 2, this.height);
            } else {
