...
public class GuiKeyBinding extends GuiListExtended {
    private final ScandiCraftGuiSettings controlsScreen;
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            boolean flag = GuiKeyBinding.this.controlsScreen.buttonId == this.keybinding;
        ...
        public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
            if (this.btnChangeKeyBinding.mousePressed(GuiKeyBinding.this.mc, p_148278_2_, p_148278_3_)) {
                GuiKeyBinding.this.controlsScreen.buttonId = this.keybinding;
                return true;
