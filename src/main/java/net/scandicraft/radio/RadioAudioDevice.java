...
/**
 * Basé sur javazoom.jl.player.JavaSoundAudioDevice
 */
public class RadioAudioDevice extends JavaSoundAudioDevice {
    private SourceDataLine source = null;
    private AudioFormat fmt = null;
    private byte[] byteBuf = new byte[4096];
    private float initVolume;

    public RadioAudioDevice(float initVolume) {
    ...
    protected DataLine.Info getSourceLineInfo() {
        ...
        DataLine.Info var2 = new DataLine.Info(SourceDataLine.class, var1);
        return var2;
    }
